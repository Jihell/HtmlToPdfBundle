        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('commands')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->integerNode('dpi')->defaultValue(150)->isRequired()->end()
                        ->scalarNode('wkhtmltopdf')->defaultValue('/usr/bin/wkhtmltopdf')->isRequired()->end()
                        ...
                        ->scalarNode('concatenate')->defaultValue('/usr/bin/pdftk')->isRequired()->end()
